    ...
    public partial class Form2 : Form
    {
        ...
        private void btPromedio_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < filas; i++)
            {
                if (matriz[i, 2] != null)
                {
                    promedio += double.Parse(matriz[i, 2]);
                    cantidad++;
                }
            }
            promedio = promedio / cantidad;
            MessageBox.Show("El promedio de las edades es: "+promedio, "Promedio",MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
